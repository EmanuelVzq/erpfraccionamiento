                    ...
                    child: Column(
                      children: [
                        ...
                        if (areaSel == null)
                          ...
                          // ✅ FIX: altura controlada para evitar overflow
                          SizedBox(
                            height: 360,
                            child: TableCalendar(
...
class _MisReservasTabState extends State<_MisReservasTab> {
  ...
  Future<void> _cargar() async {
    ...
    try {
      final res = await widget.dio.get("/reservas/persona/${widget.idPersona}");
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          final area = r["area_nombre"].toString();
          final fecha = r["fecha_reserva"].toString();
          final ini = r["hora_inicio"].toString().substring(0, 5);
