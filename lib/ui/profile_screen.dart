...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _cargarPerfil() async {
    ...
    try {
      final res = await dio.get('/persona/${widget.idUsuario}');
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final String displayName =
            nombreBackend?.isNotEmpty == true ? nombreBackend! : user.name;

        final String displayEmail =
            correoBackend?.isNotEmpty == true ? correoBackend! : user.email;
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ===== NOMBRE (desde backend por id_usuario) =====
              Center(
                child: Text(
                  displayName,
